...
class Projection {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('projection')) {
        ...
        this.projection = new Array(9).fill(0);
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Check that the constant length array field [projection] has the right length
    if (obj.projection.length !== 9) {
      throw new Error('Unable to serialize array field projection - length must be 9')
    }
    // Serialize message field [projection]
    bufferOffset = _arraySerializer.float64(obj.projection, buffer, bufferOffset, 9);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.projection = _arrayDeserializer.float64(buffer, bufferOffset, 9)
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.projection !== undefined) {
      ...
      resolved.projection = new Array(9).fill(0)
    }
